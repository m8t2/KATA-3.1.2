...
public class SecurityService implements UserDetailsService {
    ...
    private final UserRepository roleUserRepository;

    @Autowired
    public SecurityService(PasswordEncoder passwordEncoder, UserRepository userRepository, RoleRepository roleRepository, UserRepository roleUserRepository) {
